...
简体中文 | [English](https://github.com/Yotoha0303/AI_RoleTemplate/blob/main/prompt%20iteration/chatGPT_prompt_version2.0-en.md)
...
4、本`prompt`并非最终版本，而是基于作者本人的情况下，制定的临时`prompt`。它会根据作者不同的要求和目标，进行迭代和升级。
